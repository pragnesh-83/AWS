...
public class CreateTablesLoadData {
    ...
    static String productCatalogTableName = "ProductCatalogP7";
    static String forumTableName = "ForumP7";
    static String threadTableName = "ThreadP7";
    static String replyTableName = "ReplyP7";
